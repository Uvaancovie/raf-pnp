...
{
    /// <inheritdoc />
    public partial class AddTaskTeamManagement : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredNotificationChannel = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RelatedCaseStatus = table.Column<int>(type: "int", nullable: true),
                    IsWorkflowTask = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WhatsAppMessages_Cases_CaseId",
                        column: x => x.CaseId,
                        principalTable: "Cases",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_WhatsAppMessages_Tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WhatsAppMessages_CaseId",
                table: "WhatsAppMessages",
                column: "CaseId");

            migrationBuilder.CreateIndex(
                name: "IX_WhatsAppMessages_CreatedDate",
                table: "WhatsAppMessages",
                column: "CreatedDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WhatsAppMessages_TaskId",
                table: "WhatsAppMessages",
                column: "TaskId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Cases_Teams_AssignedTeamId",
                table: "Cases",
                column: "AssignedTeamId",
                principalTable: "Teams",
                principalColumn: "Id",
